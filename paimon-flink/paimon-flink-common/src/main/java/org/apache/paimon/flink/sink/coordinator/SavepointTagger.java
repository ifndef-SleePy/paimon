...
/**
 * Creates and deletes {@code savepoint-<checkpointId>} tags on behalf of {@link
 * CommittingWriteOperatorCoordinator}, replicating the semantics of the classic {@link
 * AutoTagForSavepointCommitterOperator} for the coordinator-commit path.
 */
public class SavepointTagger {
    ...
    /** Tags each committed snapshot whose commit identifier is one of {@code identifiers}. */
    public void createTags(Collection<Long> identifiers) {
    ...
    /** Deletes the {@code savepoint-<id>} tag if it was already created. */
    public void deleteTagIfExists(long id) {
        String tagName = AutoTagForSavepointCommitterOperator.SAVEPOINT_TAG_PREFIX + id;
